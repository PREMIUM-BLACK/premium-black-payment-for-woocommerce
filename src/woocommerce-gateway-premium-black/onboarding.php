...
add_action('admin_menu', function () {
    ...
    if (empty($public_key) || empty($private_key)) {
        add_menu_page(
            __('Premium Black Setup', 'premium-black'),
            __('Premium Black Setup', 'premium-black'),
            'manage_options',
        ...
        <div class="pb-tabs">
			...
			<div class="pb-onboarding-step1">
			  <p>Please enter your public and private keys.</p>
				...
				<input type="text" id="pb_public_key" placeholder="Enter your public key" value="<?php echo $public_key ?>" class="pb-input">

				<label for="pb_private_key">Private Key</label>
				<input type="text" id="pb_private_key" placeholder="Enter your private key" value="<?php echo $private_key ?>" class="pb-input">
...
add_action("wp_ajax_pb_save_onboarding_data", function () {
    ...
    $private = sanitize_text_field($_POST['private_key'] ?? '');
